...
class TestMapping(unittest.TestCase):
    ...
    def test_is_mapping_ok_wrong_type_error(self):
        ...
        assert errors[0].__str__() == "WrongTypeError: '0.metadata.request_id' should be a(n) ['int', 'float'] not 'str'"
    ...
    def test_is_mapping_ok_wrong_format_error(self):
        ...
        assert errors[0].__str__() == "WrongFormatError: '0.metadata.request_id' should be a(n) 'int' but got 'float' instead"
